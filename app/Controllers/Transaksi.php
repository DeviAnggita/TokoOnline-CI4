...
class Transaksi extends BaseController
{
	...
	public function invoice()
	{
		...
		$this->sendEmail($attachment, 'anggitadevi277@gmail.com', 'Invoice', $message);

		return redirect()->to(site_url('transaksi/index'));
		
	}

	public function sendEmail($attachment, $title, $message)
	{
		$this->email->setFrom('anggitadevi277@gmail.com','devi123xyz');
		$this->email->setTo('anggitadevi277@gmail.com');
	...
	// {
	// 	$this->email->setFrom('anggitadevi277@gmail.com','devianggita');
	// 	$this->email->setTo('anggitadevi277@gmail.com');

	// 	$this->email->attach('Testing Email CI4');

	// 	$this->email->setSubject("Test");

	// 	$this->email->setMessage("CI4");
